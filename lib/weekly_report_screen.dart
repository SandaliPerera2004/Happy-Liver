...
class _WeeklyReportScreenState
  ...
  Future<void> _loadReport() async {
    ...
    try {
      ...
      final report =
      await widget.service.getWeeklyReport(
        startDate: startDate,
        endDate: endDate,
      );
  ...
  // ============================================================
  // AVERAGE CALORIES - NOW REAL DATA
  // ============================================================
...
class _TinyMarkPainter
  ...
  @override
  bool shouldRepaint(
      covariant _TinyMarkPainter
      oldDelegate,
      ) {
    return oldDelegate.active !=
        active;
  }
}

// ============================================================================
// CALORIES CHART - REAL USER DATA
// ============================================================================
...
class _CaloriesChartPainter
  ...
  void paint(
    ...
    // If there is no calorie data,
    // only show the day labels.
