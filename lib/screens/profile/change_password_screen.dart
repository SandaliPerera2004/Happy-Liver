...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  // Dark mode colors
  static const Color _darkBackground = Color(0xFF101810);
  static const Color _darkHeader = Color(0xFF1B3B1F);
  static const Color _darkCard = Color(0xFF1A251C);
  static const Color _darkText = Colors.white;
  static const Color _darkSecondaryText = Color(0xFFB7C1B8);
  static const Color _darkHint = Color(0xFF89958B);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
      isDarkMode ? _darkBackground : const Color(0xFFF5F6F8),
      body: SafeArea(
        child: Column(
